...
quizData.history_kamakura_muromachi = {
    ...
    questions: [
    {
        "question": "13世紀初め、チンギス・ハンが築き、孫のフビライ・ハンが都を大都（北京）に移して国号を「元」と定めた帝国はどこですか。",
        "options": [
            "モンゴル帝国",
            "明",
            "清",
        ...
        "answer": 0,
        "hint": "ユーラシア大陸にまたがる大帝国を築きました。"
    },
    {
        "question": "13世紀後半、二度にわたりモンゴル軍（元軍）が日本に襲来した出来事を何といいますか。",
        "options": [
            "源平の戦い",
            "承久の乱",
            "元寇",
        ...
        "answer": 2,
        "hint": "文永の役（1回目）と弘安の役（2回目）の総称です。"
    },
    {
        "question": "元寇の際、執権として強硬な姿勢でモンゴル軍と戦う指揮を執った鎌倉幕府の人物は誰ですか。",
        "options": [
            "北条政子",
            "北条泰時",
            "北条時宗",
    ...
    {
        "question": "元寇で日本軍（鎌倉武士）が苦戦した理由の一つとして、元軍が使用した「火薬を使う武器」は何ですか。",
        "options": [
            "鉄砲",
            "てつはう",
            "大砲",
        ...
        "answer": 1,
        "hint": "大きな音と光で日本馬を驚かせました。"
    },
    {
        "question": "鎌倉幕府が滅びた後、政治の実権を朝廷（天皇）に取り戻そうとして「建武の新政」を行った天皇は誰ですか。",
        "options": [
            "後鳥羽上皇",
            "後醍醐天皇",
            "後白河法皇",
        ...
        "answer": 1,
        "hint": "「醍醐天皇」の時代のような政治を目指しました。"
    },
    {
        "question": "建武の新政に反発し、新たに幕府（室町幕府）を開いて京都に北朝を立てた人物は誰ですか。",
        "options": [
            "足利尊氏",
            "足利義満",
            "足利義政",
        ...
        "answer": 0,
        "hint": "元々は鎌倉幕府の御家人でしたが、倒幕に協力し、後に天皇と対立しました。"
    },
    {
        "question": "室町幕府の第3代将軍で、南北朝の合一を果たし、京都の室町に「花の御所」を造営した人物は誰ですか。",
        "options": [
            "足利尊氏",
            "足利義満",
            "足利義政",
        ...
        "answer": 1,
        "hint": "金閣を建てたことでも知られます。"
    },
    {
        "question": "1467年に京都で始まり、11年間にわたって続いた、将軍の跡継ぎ問題や守護大名の対立が原因の戦乱は何ですか。",
        "options": [
            "保元の乱",
            "平治の乱",
            "応仁の乱",
        ...
        "answer": 2,
        "hint": "京都が焼け野原になり、戦国時代の幕開けとなりました。"
    },
    {
        "question": "応仁の乱で東軍と西軍に分かれて戦った中心人物（管領家の対立）の正しい組み合わせはどれですか。",
        "options": [
            "細川氏 と 山名氏",
            "足利氏 と 新田氏",
            "源氏 と 平氏",
        ...
        "answer": 0,
        "hint": "細川勝元（東軍）と山名宗全（西軍）の対立です。"
    },
    {
        "question": "1573年、織田信長によって京都から追放され、室町幕府最後の将軍となった人物は誰ですか。",
        "options": [
            "足利尊氏",
            "足利義満",
            "足利義政",
...
quizData.history_muromachi_culture = {
    ...
    questions: [
        {
            "question": "足利義満の時代に栄えた、公家文化と武家文化が融合した豪華な文化は何ですか。代表的な建築物に金閣があります。",
            "options": [
                "北山文化",
                "東山文化",
                "国風文化",
            ...
            "answer": 0,
            "hint": "京都の北山に別荘を建てたことから名付けられました。"
        },
        {
            "question": "足利義政の時代に栄えた、禅宗の精神に基づく簡素で深みのある文化は何ですか。代表的な建築物に銀閣があります。",
            "options": [
                "北山文化",
                "東山文化",
                "元禄文化",
            ...
            "answer": 1,
            "hint": "「わび・さび」を重んじる文化です。"
        },
        {
            "question": "観阿弥・世阿弥の親子によって大成された、仮面をつけて演じる日本の伝統芸能は何ですか。",
            "options": [
                "歌舞伎",
                "能（能楽）",
                "狂言",
            ...
            "answer": 1,
            "hint": "武士に愛好され、合間には「狂言」が演じられました。"
        },
        {
            "question": "室町時代に中国（明）で絵画を学び、墨の濃淡だけで自然を表現する「水墨画」を日本で大成させた人物は誰ですか。",
            "options": [
                "狩野永徳",
                "雪舟",
                "運慶",
            ...
            "answer": 1,
            "hint": "涙でネズミの絵を描いた伝説でも有名です。"
        },
        {
            "question": "鎌倉時代に広まった新しい仏教のうち、「悪人正機（悪人こそが救われる）」を説き、浄土真宗（一向宗）を開いたのは誰ですか。",
            "options": [
                "法然",
                "親鸞",
                "一遍",
        ...
        {
            "question": "禅宗の一つである曹洞宗を開き、ひたすら座禅を行う「只管打坐（しかんたざ）」を説いた人物は誰ですか。",
            "options": [
                "栄西",
                "道元",
                "隠元",
        ...
        {
            "question": "室町時代の住宅様式「書院造」に見られる、掛け軸や花を飾るために一段高く作られた場所を何といいますか。",
            "options": [
                "床の間",
                "縁側",
                "欄間",
