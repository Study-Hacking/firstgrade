...
quizData.history_workbook = {
    ...
    questions:
        [
            {
                "question": "13世紀初め、モンゴル民族を統一し、モンゴル帝国を築いた人物は誰ですか。",
                "options": [
                    "フビライ・ハン",
                    "チンギス・ハン",
                    "マルコ・ポーロ",
            ...
            },
            {
                ...
                "answer": 2,
                "hint": "日本に服属を求めて使者を送ってきました。"
            },
            {
                "question": "元（モンゴル帝国）の都はどこに置かれましたか。",
                "options": [
                    "長安",
                    "南京",
                    "大都",
            ...
            {
                "question": "文永の役と弘安の役、この二度の元軍の襲来を合わせて何といいますか。",
                "options": [
                    "源平の合戦",
                    "南北朝の動乱",
                    "元寇",
            ...
            {
                "question": "元軍が使用した、火薬を爆発させる武器を当時の言葉で何といいますか。",
                "options": [
                    "鉄砲",
                    "大砲",
                    "てつはう",
            ...
            },
            {
                ...
                "answer": 1,
                "hint": "元軍の上陸を防ぐために作られました。"
            },
            {
                "question": "元寇での戦い方の違いとして、日本軍の特徴はどれですか。",
                "options": [
                    "集団戦法",
                    "一騎打ち",
                    "火器の使用",
                ...
                "answer": 1,
                "hint": "「やあやあ我こそは」と名乗りを上げて戦いました。"
            },
            {
                "question": "元寇での戦い方の違いとして、元軍の特徴はどれですか。",
                "options": [
                    "一騎打ち",
                    "集団戦法",
                    "刀のみの使用",
            ...
            {
                "question": "徳政令（永仁の徳政令）が出された結果、御家人の生活はどうなりましたか。",
                "options": [
                    "豊かになった",
                    "借金ができなくなり、かえって苦しくなった",
                    "借金がすべて返済され安定した",
                    "商人がお金を貸してくれるようになった"
                ],
                "answer": 1,
                "hint": "お金を貸す側（土倉など）が貸さなくなりました。"
            },
            {
                "question": "マルコ・ポーロは日本を何という名前でヨーロッパに紹介しましたか。",
                "options": [
                    "黄金の国ジパング",
                    "日出ずる国",
                    "大和",
            ...
            {
                "question": "鎌倉幕府を滅ぼした後、天皇中心の政治（建武の新政）を始めたのは誰ですか。",
                "options": [
                    "後鳥羽上皇",
                    "後醍醐天皇",
                    "後白河法皇",
                ...
                "answer": 1,
                "hint": "一度は隠岐に流されましたが、幕府を倒しました。"
            },
            {
                "question": "1333年に鎌倉幕府を攻め滅ぼした有力御家人の一人で、京都の六波羅探題を攻め落としたのは誰ですか。",
                "options": [
                    "新田義貞",
                    "足利尊氏",
                    "楠木正成",
            ...
            {
                "question": "建武の新政が崩れた後、足利尊氏が京都に立てた朝廷を何といいますか。",
                "options": [
                    "南朝",
                    "北朝",
                    "東朝",
            ...
            {
                "question": "足利尊氏に対抗して、後醍醐天皇が吉野（奈良県）に立てた朝廷を何といいますか。",
                "options": [
                    "北朝",
                    "南朝",
                    "西朝",
            ...
            {
                "question": "室町時代、守護が国内の武士をまとめて領国を支配するようになった存在を何といいますか。",
                "options": [
                    "地頭",
                    "守護大名",
                    "戦国大名",
            ...
            {
                "question": "室町幕府において、将軍の補佐役として置かれた役職は何ですか。",
                "options": [
                    "執権",
                    "管領",
                    "老中",
            ...
            {
                "question": "日明貿易で日本が輸入した主な品物は何ですか。",
                "options": [
                    "銅銭・生糸",
                    "日本刀・銅",
                    "硫黄・扇",
            ...
            {
                "question": "日明貿易で日本が輸出した主な品物は、刀、硫黄とあと一つは何ですか。",
                "options": [
                    "銅",
                    "鉄砲",
                    "綿花",
            ...
            {
                "question": "14世紀末、朝鮮半島で高麗を倒して建国された国は何ですか。",
                "options": [
                    "新羅",
                    "朝鮮国（李氏朝鮮）",
                    "百済",
            ...
            {
                "question": "朝鮮国（李氏朝鮮）で制定された、独自の文字を何といいますか。",
                "options": [
                    "漢字",
                    "仮名",
                    "ハングル",
            ...
            },
            {
                ...
                "answer": 0,
                "hint": "各地の産物を中継して利益を得ました。"
            },
            {
                "question": "1457年、和人の進出に対してアイヌ民族が蜂起した戦いの中心人物は誰ですか。",
                "options": [
                    "シャクシャイン",
                    "コシャマイン",
                    "アテルイ",
            ...
            {
                "question": "アイヌ民族が和人との交易で輸出した主な海産物は、サケと何ですか。",
                "options": [
                    "マグロ",
                    "昆布",
                    "カニ",
            ...
            },
            {
                ...
                "answer": 0,
                "hint": "フランシスコ・ザビエルも「日本最大の大学」と紹介しました。"
            },
            {
            ...
            },
            {
                ...
                "answer": 1,
                "hint": "平氏の繁栄と没落を描いています。"
            },
            {
                "question": "鎌倉時代、兼好法師が書いた随筆集は何ですか。",
                "options": [
                    "枕草子",
                    "徒然草",
                    "方丈記",
            ...
            {
                "question": "元寇の際、日本軍が築いた石の防壁（防塁）は、どこの湾の沿岸に作られましたか。",
                "options": [
                    "博多湾",
                    "東京湾",
                    "大阪湾",
            ...
            {
                "question": "戦国大名・毛利元就が本拠地としたのは、現在の広島県にあたる何という国ですか。",
                "options": [
                    "安芸",
                    "駿河",
                    "越後",
            ...
            {
                "question": "戦国大名・上杉謙信が本拠地としたのは、現在の新潟県にあたる何という国ですか。",
                "options": [
                    "越後",
                    "安芸",
                    "駿河",
            ...
            {
                "question": "戦国大名・武田信玄が本拠地としたのは、現在の山梨県にあたる何という国ですか。",
                "options": [
                    "甲斐",
                    "安芸",
                    "越後",
            ...
            {
                "question": "1096年に始まり、聖地エルサレムをイスラム勢力から取り戻そうとしたヨーロッパの軍隊は何ですか。",
                "options": [
                    "十字軍",
                    "元軍",
                    "倭寇",
            ...
            },
            {
                ...
                "answer": 0,
                "hint": "キリスト教、イスラム教、ユダヤ教の聖地です。"
            },
            {
                "question": "フビライ・ハンが定めた「元」という国号は、どこの国の風習を取り入れたものですか。",
                "options": [
                    "中国",
                    "日本",
                    "インド",
            ...
            {
                "question": "元寇の際、対馬や壱岐の人々はどうなりましたか。",
                "options": [
                    "大きな被害を受けた",
                    "平和に過ごした",
                    "元軍と協力した",
                ...
                "answer": 0,
                "hint": "元軍の襲来ルート上にありました。"
            },
            {
                "question": "元寇の後、御家人が土地を売らなければならなくなった理由の一つは何ですか。",
                "options": [
                    "領地の分割相続",
                    "戦いがなかったから",
                    "幕府の税金が高かったから",
                ...
                "answer": 0,
                "hint": "代を重ねるごとに土地が狭くなりました。"
            },
            {
                "question": "後醍醐天皇が建武の新政で重視したのは、武士よりも誰ですか。",
                "options": [
                    "公家（貴族）",
                    "農民",
                    "商人",
            ...
            {
                "question": "室町幕府において、将軍の直轄軍として置かれたのは何ですか。（※画像内から推測）",
                "options": [
                    "奉公衆",
                    "御家人",
                    "旗本",
                ...
                "answer": 0,
                "hint": "（注：画像3の組織図に「奉公衆」があります）"
            },
            {
                "question": "室町幕府の組織図において、侍所の長官を何といいますか。（画像3参照）",
                "options": [
                    "所司",
                    "執事",
                    "管領",
                ...
                "answer": 0,
                "hint": "京都市中の警備などを担当しました。"
            },
            {
                "question": "朝鮮国（李氏朝鮮）を建国した人物は誰ですか。",
                "options": [
                    "李成桂",
                    "王建",
                    "世宗",
            ...
            {
                "question": "室町時代、農村で灌漑用水を汲み上げるために使われた、中国から伝わった道具は何ですか。",
                "options": [
                    "竜骨車",
                    "千歯扱き",
                    "唐箕",
            ...
            {
                "question": "室町時代、京都の町衆が自治組織を作って運営した有名な祭りは何ですか。",
                "options": [
                    "祇園祭",
                    "天神祭",
                    "神田祭",
            ...
            {
                "question": "銀閣の庭園に見られる、石や砂で自然の風景を表現した様式を何といいますか。",
                "options": [
                    "枯山水",
                    "回遊式庭園",
                    "浄土式庭園",
            ...
            {
                "question": "書院造の特徴である、明かり取りのための窓を何といいますか。",
                "options": [
                    "付書院",
                    "欄間",
                    "床の間",
                ...
                "answer": 0,
                "hint": "机のように張り出した部分の上にある窓です。"
            },
            {
                "question": "雪舟が描いた代表的な水墨画の作品名は何ですか。",
                "options": [
                    "秋冬山水図",
                    "鳥獣戯画",
                    "富嶽三十六景",
            ...
            {
                "question": "鎌倉時代、念仏を唱えながら踊る「踊念仏」を広めた僧は誰ですか。",
                "options": [
                    "一遍",
                    "親鸞",
                    "日蓮",
            ...
            {
                "question": "鎌倉時代、「南無妙法蓮華経」という題目を唱えることを説いた僧は誰ですか。",
                "options": [
                    "日蓮",
                    "一遍",
                    "道元",
            ...
            {
                "question": "鎌倉時代、ひたすら座禅を行う「只管打坐」を説いた禅宗の宗派は何ですか。",
                "options": [
                    "曹洞宗",
                    "臨済宗",
                    "浄土宗",
            ...
            {
                "question": "鎌倉時代、公案（禅問答）を使って悟りを開こうとする禅宗の宗派は何ですか。",
                "options": [
                    "臨済宗",
                    "曹洞宗",
                    "時宗",
            ...
            {
                "question": "足利義政の時代、東山文化で茶の湯が流行しましたが、茶を飲む習慣は元々どこから伝わりましたか。",
                "options": [
                    "宋（中国）",
                    "朝鮮",
                    "インド",
            ...
            {
                "question": "室町時代、京都の五山を中心に栄えた、禅僧による漢詩文の文化を何といいますか。",
                "options": [
                    "五山文学",
                    "国風文化",
                    "元禄文化",
            ...
            {
                "question": "室町時代、村の自治組織「惣」の指導者を何と呼びましたか。",
                "options": [
                    "乙名（おとな）",
                    "地頭",
                    "名主",
            ...
            {
                "question": "室町時代、借金の質草を保管する蔵を持っていた金融業者を何といいますか。",
                "options": [
                    "土倉",
                    "問屋",
                    "馬借",
                ...
                "answer": 0,
                "hint": "酒屋とともに高利貸しを行いました。"
            },
            {
                "question": "正長の土一揆で、農民たちが襲撃したのは土倉や何ですか。",
                "options": [
                    "酒屋",
                    "米屋",
                    "役所",
            ...
            {
                "question": "1274年の文永の役で、元軍が上陸したのは博多湾のほかにどこですか。",
                "options": [
                    "肥前（長崎県）",
                    "薩摩（鹿児島県）",
                    "長門（山口県）",
